...
export default function HomePage() {
  return (
    <div className="min-h-screen bg-[url('/roses.jpg')] bg-cover bg-center bg-no-repeat bg-fixed">
      ...
      {/* Gift Section */}
      <section className="p-6 md:p-12 bg-gradient-to-b from-gray-100 to-gray-200">
        <div className="container mx-auto max-w-4xl text-center">
          <h2 className="text-4xl font-serif text-gray-800 mb-8">
        Lista de Presentes
          </h2>
          <p className="text-gray-700 font-serif text-lg leading-relaxed mb-8 px-4">
        ...
        <Card className="border-red-200 bg-white/70 backdrop-blur-sm">
          ...
          Contribua via PIX
            ...
            <p className="text-gray-700 font-serif text-sm md:text-base leading-relaxed mb-6">
          ...
          <p className="font-mono text-red-800 font-semibold break-all text-sm">
        ...
        <Card className="border-red-200 bg-white/70 backdrop-blur-sm">
          ...
          QR Code PIX
            ...
            <div className="bg-white p-4 md:p-6 rounded-lg shadow-inner mb-4 mx-auto max-w-xs">
          <div className="w-32 h-32 md:w-48 md:h-48 mx-auto bg-gray-200 border-2 border-gray-300 rounded-lg flex items-center justify-center">
            <Image 
              src="/qrcode.png" 
              alt="QR Code PIX" 
              width={128}
              height={128}
              className="mx-auto md:w-48 md:h-48"
            />
          </div>
            </div>
